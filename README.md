...
- **CSV export** met 3 kolommen (Woord · Antwoord · Tag), waarbij de tag het
  niveau is. Bij gewijzigde antwoorden wordt automatisch alleen het meest
  recente antwoord per woord geëxporteerd.
